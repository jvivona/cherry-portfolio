<?php
/**
 * Handles custom post meta boxes for the 'portfolio' post type.
 *
...
class Cherry_Portfolio_Meta_Boxes {
	...
	/**
	 * Metabox post format UI settings.
	 *
	 * @param  string $format Post format slug.
	 * @return array          Metabox post format UI settings.
	 */
