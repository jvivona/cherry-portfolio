...
if ( ! class_exists( 'Portfolio_Options' ) ) {
	...
	/**
	 * Sets up and initializes Portfolio Options class.
	 *
	 * @since 1.0.0
	 */
	class Portfolio_Options {
		...
		private function __construct() {
			...
			$this->portfolio_options['portfolio-listing-layout'] = array(
				'type'			=> 'radio',
			...
			$this->portfolio_options['portfolio-loading-mode'] = array(
				'type'			=> 'radio',
			...
			$this->portfolio_options['portfolio-loading-animation'] = array(
				'type'			=> 'radio',
			...
			$this->portfolio_options['portfolio-hover-animation'] = array(
				'type'			=> 'radio',
			...
			$this->portfolio_options['portfolio-filter-type'] = array(
				'type'			=> 'radio',
				'title'			=> 'Filter type',
			...
			$this->portfolio_options['portfolio-category-list'] = array(
				'type'			=> 'select',
				'title'			=> __( 'Portfolio filter categories list', 'cherry-portfolio' ),
				'label'			=> '',
				'description'	=> '',
				'multiple'		=> true,
			...
			$this->portfolio_options['portfolio-tags-list'] = array(
				'type'			=> 'select',
				'title'			=> __( 'Portfolio filter tags list', 'cherry-portfolio' ),
				'label'			=> '',
				'description'	=> '',
				'multiple'		=> true,
				'value'			=> array( 'select-1','select-2' ),
			...
			$this->portfolio_options['portfolio-filter-visible'] = array(
				'type'			=> 'switcher',
				'title'			=> __( 'Filters', 'cherry-portfolio' ),
				'description'	=> __( 'Enable/disable listing filters', 'cherry-portfolio' ),
				'value'			=> 'true',
			);
			$this->portfolio_options['portfolio-order-filter-visible'] = array(
				'type'			=> 'switcher',
				'title'			=> __( 'Order filters', 'cherry-portfolio' ),
				'description'	=> __( 'Enable/disable order filters', 'cherry-portfolio' ),
				'value'			=> 'false',
			);
			$this->portfolio_options['portfolio-order-filter-default-value'] = array(
				'type'			=> 'radio',
				'title'			=> __( 'Order filter default value', 'cherry-portfolio' ),
				'value'			=> 'desc',
				'display-input'	=> true,
				'options'		=> array(
					'desc' => array(
			...
			$this->portfolio_options['portfolio-orderby-filter-default-value'] = array(
				'type'			=> 'radio',
				'title'			=> __( 'Order by filter default value', 'cherry-portfolio' ),
				'value'			=> 'date',
				'display-input'	=> true,
				'options'		=> array(
					'date' => array(
			...
			$this->portfolio_options['portfolio-column-number'] = array(
				'type'			=> 'slider',
			...
			$this->portfolio_options['portfolio-post-per-page'] = array(
				'type'			=> 'slider',
			...
			$this->portfolio_options['portfolio-item-margin'] = array(
				'type'			=> 'slider',
			...
			$this->portfolio_options['portfolio-justified-fixed-height'] = array(
				'type'			=> 'slider',
			...
			$this->portfolio_options['portfolio-crop-image-height'] = array(
				'type'			=> 'stepper',
			...
			$this->portfolio_options['portfolio-more-button-text'] = array(
				'type'			=> 'text',
			...
			$this->portfolio_options['portfolio-prev-button-text'] = array(
				'type'			=> 'text',
			...
			$this->portfolio_options['portfolio-next-button-text'] = array(
				'type'			=> 'text',
			...
			$this->portfolio_options['portfolio-masonry-template'] = array(
				'type'			=> 'text',
			...
			$this->portfolio_options['portfolio-list-template'] = array(
				'type'			=> 'text',
				'title'			=> __( 'List template', 'cherry-portfolio' ),
				'description'	=> __( 'List content template', 'cherry-portfolio' ),
				'value'			=> 'list-default.tmpl',
			);
			$this->portfolio_options['portfolio-single-standart-template'] = array(
				'type'			=> 'text',
			...
			$this->portfolio_options['portfolio-single-image-template'] = array(
				'type'			=> 'text',
			...
			$this->portfolio_options['portfolio-single-gallery-template'] = array(
				'type'			=> 'text',
			...
			$this->portfolio_options['portfolio-single-audio-template'] = array(
				'type'			=> 'text',
			...
			$this->portfolio_options['portfolio-single-video-template'] = array(
				'type'			=> 'text',
		...
		/**
		 * Add portfolio options to default cherry options.
		 *
		 * @param  array $result_array Current option array.
		 * @return array               Updated option array.
		 */
		function cherry_portfolio_settings( $result_array ) {

			$portfolio_options = apply_filters( 'cherry_portfolio_default_settings', $this->portfolio_options );
	 ...
	 * @return object
	 */
	function cherry_portfolio_options_class() {
		return Portfolio_Options::get_instance();
	}
}
